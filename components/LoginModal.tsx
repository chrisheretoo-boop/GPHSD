  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-xl p-4">
        ...
        <div className="relative w-full max-w-md animate-fade-in flex flex-col items-center">
            ...
            {/* Glow Effect */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg h-full max-h-[500px] bg-gold-500/10 blur-[100px] rounded-full pointer-events-none"></div>
