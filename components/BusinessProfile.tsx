...
import { ArrowLeft, MapPin, Clock, DollarSign, User, Mail, Globe, Share2, Star, Send, LogIn, Copy, ExternalLink, Phone, Instagram, Twitter, Facebook, X, AlertTriangle, ChevronLeft, ChevronRight, Loader2, Sparkles, BadgeCheck } from 'lucide-react';
...
export const BusinessProfile: React.FC<Props> = ({ business, onBack, user, onLogin, onRefresh }) => {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 pt-32 pb-20 px-6 animate-fade-in">
